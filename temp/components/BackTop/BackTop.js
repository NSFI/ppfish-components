...
var BackTop = /** @class */ (function (_super) {
    ...
    function BackTop(props) {
        ...
        _this.handleScroll = function () {
            var _a = _this.props, visibilityHeight = _a.visibilityHeight, _b = _a.target, target = _b === void 0 ? getDefaultTarget : _b;
    ...
    BackTop.prototype.render = function () {
        var _a = this.props, _b = _a.prefixCls, prefixCls = _b === void 0 ? 'fishd-back-top' : _b, _c = _a.className, className = _c === void 0 ? '' : _c, children = _a.children;
        var classString = classNames(prefixCls, className);
        var defaultElement = (React.createElement("div", { className: prefixCls + "-content" },
            React.createElement("div", { className: prefixCls + "-icon" })));
        // fix https://fb.me/react-unknown-prop
        var divProps = omit(this.props, [
            'prefixCls',
            'className',
            'children',
            'visibilityHeight',
        ...
        var backTopBtn = this.state.visible ? (React.createElement("div", __assign({}, divProps, { className: classString, onClick: this.scrollToTop }), children || defaultElement)) : null;
