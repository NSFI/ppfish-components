...
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.render = function () {
        var _a = this.props, placeholder = _a.placeholder, value = _a.value, prefixCls = _a.prefixCls;
        var icon = value && value.length > 0 ? (React.createElement("a", { href: "#", className: prefixCls + "-action", onClick: this.handleClear },
