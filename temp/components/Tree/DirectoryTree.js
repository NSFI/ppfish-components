...
var DirectoryTree = /** @class */ (function (_super) {
    ...
    function DirectoryTree(props) {
        ...
        _this.onClick = function (event, node) {
            var _a = _this.props, onClick = _a.onClick, expandAction = _a.expandAction;
            // Expand the tree
        ...
        _this.onDoubleClick = function (event, node) {
            var _a = _this.props, onDoubleClick = _a.onDoubleClick, expandAction = _a.expandAction;
            // Expand the tree
        ...
        _this.onSelect = function (keys, event) {
            var _a = _this.props, onSelect = _a.onSelect, multiple = _a.multiple, children = _a.children;
            var _b = _this.state, _c = _b.expandedKeys, expandedKeys = _c === void 0 ? [] : _c, _d = _b.selectedKeys, selectedKeys = _d === void 0 ? [] : _d;
            var node = event.node, nativeEvent = event.nativeEvent;
            var _e = node.props.eventKey, eventKey = _e === void 0 ? '' : _e;
            var newState = {};
        ...
        var defaultExpandAll = props.defaultExpandAll, defaultExpandParent = props.defaultExpandParent, expandedKeys = props.expandedKeys, defaultExpandedKeys = props.defaultExpandedKeys, children = props.children;
    ...
    DirectoryTree.prototype.render = function () {
        var _this = this;
        var _a = this.props, prefixCls = _a.prefixCls, className = _a.className, props = __rest(_a, ["prefixCls", "className"]);
        var _b = this.state, expandedKeys = _b.expandedKeys, selectedKeys = _b.selectedKeys;
        var connectClassName = classNames(prefixCls + "-directory", className);
        return (React.createElement(Tree, __assign({ icon: getIcon, ref: function (node) { return (_this.tree = node); } }, props, { prefixCls: prefixCls, className: connectClassName, expandedKeys: expandedKeys, selectedKeys: selectedKeys, onSelect: this.onSelect, onClick: this.onClick, onDoubleClick: this.onDoubleClick, onExpand: this.onExpand })));
    };
