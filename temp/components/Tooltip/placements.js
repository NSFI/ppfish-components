...
export default function getPlacements(config) {
    ...
    Object.keys(placementMap).forEach(function (key) {
        placementMap[key] = config.arrowPointAtCenter
            ? __assign(__assign({}, placementMap[key]), { overflow: getOverflowOptions(autoAdjustOverflow), targetOffset: targetOffset }) : __assign(__assign({}, rcPlacements[key]), { overflow: getOverflowOptions(autoAdjustOverflow) });
    });
    return placementMap;
}
