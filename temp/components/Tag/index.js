...
var Tag = /** @class */ (function (_super) {
    ...
    Tag.prototype.render = function () {
        var _a;
        var _b = this.props, prefixCls = _b.prefixCls, closable = _b.closable, color = _b.color, className = _b.className, children = _b.children, style = _b.style, autoShowClose = _b.autoShowClose, otherProps = __rest(_b, ["prefixCls", "closable", "color", "className", "children", "style", "autoShowClose"]);
        ...
        var tag = this.state.closed ? null : (React.createElement("div", __assign({ "data-show": !this.state.closing }, divProps, { className: classString, style: tagStyle }),
            children,
            closeIcon));
