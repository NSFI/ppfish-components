...
var Anchor = /** @class */ (function (_super) {
    ...
    function Anchor() {
        ...
        _this.handleScroll = function () {
            ...
            var _a = _this.props, offsetTop = _a.offsetTop, bounds = _a.bounds;
            _this.setState({
                activeLink: _this.getCurrentAnchor(offsetTop, bounds)
            });
        };
        _this.handleScrollTo = function (link) {
            var _a = _this.props, offsetTop = _a.offsetTop, getContainer = _a.getContainer;
    ...
    Anchor.prototype.getChildContext = function () {
        ...
        return { fishdAnchor: fishdAnchor };
    };
    ...
    Anchor.prototype.render = function () {
        var _a;
        var _b = this.props, prefixCls = _b.prefixCls, _c = _b.className, className = _c === void 0 ? '' : _c, style = _b.style, offsetTop = _b.offsetTop, affix = _b.affix, showInkInFixed = _b.showInkInFixed, children = _b.children, getContainer = _b.getContainer, inkPosition = _b.inkPosition;
        ...
        var inkNodeClass = classNames((_a = {},
            _a[prefixCls + "-ink"] = true,
            _a[prefixCls + "-ink-left"] = inkPosition === 'left',
            _a[prefixCls + "-ink-right"] = inkPosition === 'right',
            _a));
        var anchorContent = (React.createElement("div", { className: wrapperClass, style: wrapperStyle },
            React.createElement("div", { className: anchorClass },
                React.createElement("div", { className: inkNodeClass },
