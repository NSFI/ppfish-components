...
var AnchorLink = /** @class */ (function (_super) {
    ...
    function AnchorLink() {
        ...
        _this.handleClick = function (e) {
            var _a = _this.context.fishdAnchor, scrollTo = _a.scrollTo, onClick = _a.onClick;
    ...
    AnchorLink.prototype.render = function () {
        var _a, _b;
        var _c = this.props, prefixCls = _c.prefixCls, href = _c.href, title = _c.title, children = _c.children;
        var active = this.context.fishdAnchor.activeLink === href;
        var wrapperClassName = classNames(prefixCls + "-link", (_a = {},
            _a[prefixCls + "-link-active"] = active,
            _a));
        var titleClassName = classNames(prefixCls + "-link-title", (_b = {},
            _b[prefixCls + "-link-title-active"] = active,
            _b));
        if (children) {
            return (React.createElement("div", { className: prefixCls + "-link-group" },
                React.createElement("div", { className: wrapperClassName },
                    React.createElement("a", { className: titleClassName, 
                        // href={href}
                        title: typeof title === 'string' ? title : '', onClick: this.handleClick }, title)),
