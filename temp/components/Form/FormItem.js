...
var FormItem = /** @class */ (function (_super) {
        ...
        if (help === undefined && this.getOnlyControl()) {
            ...
            if (errors) {
                return intersperse(errors.map(function (e, index) {
                    return React.isValidElement(e.message)
    ...
    FormItem.prototype.renderExtra = function () {
        var _a = this.props, prefixCls = _a.prefixCls, extra = _a.extra;
    ...
    FormItem.prototype.renderValidateWrapper = function (c1, c2, c3) {
        ...
        var onlyControl = this.getOnlyControl;
        var validateStatus = props.validateStatus === undefined && onlyControl
    ...
    FormItem.prototype.renderWrapper = function (children) {
        var _a = this.props, prefixCls = _a.prefixCls, wrapperCol = _a.wrapperCol;
        var className = classNames(prefixCls + "-item-control-wrapper", wrapperCol && wrapperCol.className);
        return (React.createElement(Col, __assign({}, wrapperCol, { className: className, key: "wrapper" }), children));
    };
    FormItem.prototype.isRequired = function () {
        ...
        if (this.getOnlyControl()) {
            ...
            return validate
                .filter(function (item) { return !!item.rules; })
                .some(function (item) {
                return item.rules.some(function (rule) { return rule.required; });
            });
        }
        return false;
    };
    FormItem.prototype.renderLabel = function () {
        var _a;
        var _b = this.props, prefixCls = _b.prefixCls, label = _b.label, labelCol = _b.labelCol, colon = _b.colon, id = _b.id;
        var context = this.context;
        var required = this.isRequired();
        var labelColClassName = classNames(prefixCls + "-item-label", labelCol && labelCol.className);
        var labelClassName = classNames((_a = {},
            _a[prefixCls + "-item-required"] = required,
            _a));
        ...
        return label ? (React.createElement(Col, __assign({}, labelCol, { className: labelColClassName, key: "label" }),
    ...
    FormItem.prototype.renderFormItem = function (children) {
        ...
        var itemClassName = (_a = {},
            _a[prefixCls + "-item"] = true,
            _a[prefixCls + "-item-with-help"] = this.helpShow,
            _a[prefixCls + "-item-no-colon"] = !props.colon,
