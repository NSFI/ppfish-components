...
var Sider = /** @class */ (function (_super) {
    ...
    Sider.prototype.render = function () {
        var _a;
        var _b = this.props, prefixCls = _b.prefixCls, className = _b.className, theme = _b.theme, collapsible = _b.collapsible, reverseArrow = _b.reverseArrow, trigger = _b.trigger, style = _b.style, width = _b.width, collapsedWidth = _b.collapsedWidth, others = __rest(_b, ["prefixCls", "className", "theme", "collapsible", "reverseArrow", "trigger", "style", "width", "collapsedWidth"]);
        var divProps = omit(others, [
            'collapsed',
            'defaultCollapsed',
            'onCollapse',
            'breakpoint',
        ...
        var zeroWidthTrigger = parseFloat(String(collapsedWidth || 0)) === 0 ? (React.createElement("span", { onClick: this.toggle, className: prefixCls + "-zero-width-trigger" },
        ...
        var triggerDom = trigger !== null
            ...
            : null;
        var divStyle = __assign(__assign({}, style), { flex: "0 0 " + siderWidth, maxWidth: siderWidth, minWidth: siderWidth, width: siderWidth });
        var siderCls = classNames(className, prefixCls, prefixCls + "-" + theme, (_a = {},
            _a[prefixCls + "-collapsed"] = !!this.state.collapsed,
            _a[prefixCls + "-has-trigger"] = collapsible && trigger !== null && !zeroWidthTrigger,
            _a[prefixCls + "-below"] = !!this.state.below,
            _a[prefixCls + "-zero-width"] = parseFloat(siderWidth) === 0,
            _a));
        return (React.createElement("div", __assign({ className: siderCls }, divProps, { style: divStyle }),
