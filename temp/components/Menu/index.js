...
var Menu = /** @class */ (function (_super) {
    ...
    Menu.prototype.componentDidUpdate = function (prevProps, prevState, snapshot) {
        ...
        else if ((!this.props.inlineCollapsed && prevProps.inlineCollapsed) ||
            (!this.context.siderCollapsed && this.siderCollapsed)) {
    ...
    Menu.prototype.getMenuOpenAnimation = function (menuMode) {
        var _this = this;
        var _a = this.props, openAnimation = _a.openAnimation, openTransitionName = _a.openTransitionName;
        ...
        if (openAnimation === undefined && openTransitionName === undefined) {
            switch (menuMode) {
                ...
                case 'vertical-right':
                    ...
                    break;
                case 'inline':
                    menuOpenAnimation = __assign(__assign({}, animation), { leave: function (node, done) {
    ...
    Menu.prototype.render = function () {
        var _a;
        var _b = this.props, prefixCls = _b.prefixCls, className = _b.className, theme = _b.theme;
        var menuMode = this.getRealMenuMode();
        var menuOpenAnimation = this.getMenuOpenAnimation(menuMode);
        var menuClassName = classNames(className, prefixCls + "-" + theme, (_a = {},
            _a[prefixCls + "-inline-collapsed"] = this.getInlineCollapsed(),
            _a));
        var menuProps = {
