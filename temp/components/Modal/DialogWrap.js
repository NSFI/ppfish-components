...
var DialogWrap = /** @class */ (function (_super) {
    ...
    function DialogWrap() {
        ...
        _this.getComponent = function (extra) {
            ...
            return React.createElement(Dialog, __assign({ ref: _this.saveDialog }, _this.props, extra, { key: "dialog" }));
        };
        // fix issue #10656
        /*
    ...
    DialogWrap.prototype.render = function () {
        ...
        var portal = null;
        if (!IS_REACT_16) {
            return (React.createElement(ContainerRender, { parent: this, visible: visible, autoDestroy: false, getComponent: this.getComponent, getContainer: this.getContainer }, function (_a) {
                var renderComponent = _a.renderComponent, removeContainer = _a.removeContainer;
