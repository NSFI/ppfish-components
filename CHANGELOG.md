## [2.2.1-alpha.0](https://github.com/NSFI/ppfish-components/compare/1.9.4-alpha.0...v2.2.1-alpha.0) (2022-08-12)

## [1.9.4-alpha.0](https://github.com/NSFI/ppfish-components/compare/v2.2.0...1.9.4-alpha.0) (2022-08-09)
...
## [2.1.4](https://github.com/NSFI/ppfish-components/compare/v2.1.3...v2.1.4) (2022-06-23)

### Bug Fixes

- remove quilljs export{} ([034c6d0](https://github.com/NSFI/ppfish-components/commit/034c6d040478691991f95087a23b5631633b3f15))

## [2.1.3](https://github.com/NSFI/ppfish-components/compare/v2.1.1...v2.1.3) (2022-06-15)
...
- ts-jest 版本控制 ([6e1bc41](https://github.com/NSFI/ppfish-components/commit/6e1bc4146110915499aa074f33ab41d1c7d27c24))
- 修复 PicturePreiview 在组件 unmount 里移除 document.body 问题 ([c4a0a86](https://github.com/NSFI/ppfish-components/commit/c4a0a8662f91bf5267166df44a2a52bddf5149d8))

### Features

- verison update ([d586f89](https://github.com/NSFI/ppfish-components/commit/d586f894c1feb7c73fc5bebe0961fb2d509e16f1))

## [2.1.1](https://github.com/NSFI/ppfish-components/compare/v2.1.0...v2.1.1) (2022-04-11)
...
# [2.1.0](https://github.com/NSFI/ppfish-components/compare/v2.0.1-alpha.2...v2.1.0) (2022-04-01)
...
- 优化 workflows 脚本 ([10e6cc6](https://github.com/NSFI/ppfish-components/commit/10e6cc6f588b807490b62834f64f17b1d4485cd6))
- 修改 gh-pages 路径 ([3f90052](https://github.com/NSFI/ppfish-components/commit/3f900520b4587f00bb0fc67a1e216f5d65512df2))

## [2.0.1-alpha.2](https://github.com/NSFI/ppfish-components/compare/v2.0.0...v2.0.1-alpha.2) (2022-03-07)

### Bug Fixes

- AudioPlayer 组件 ref 问题 ([6cc1676](https://github.com/NSFI/ppfish-components/commit/6cc1676f62d6bdbc6392b0bb861a80a3d5107bee))
- radioGroup 的 ref 修改 ([f666f87](https://github.com/NSFI/ppfish-components/commit/f666f876265db4f4e2b35dd13b21571777786d16))
- radioGroup 组件在 form 中报警告 ([c636785](https://github.com/NSFI/ppfish-components/commit/c636785baf4ceb37b9fa0a8a6990368ff1a81b26))
...
- select 组件增加 customAction ([43c114a](https://github.com/NSFI/ppfish-components/commit/43c114ac14eb3a74c1bda4681b0443f27ba0a88a))

# [2.0.0](https://github.com/NSFI/ppfish-components/compare/v2.0.0-rc.1...v2.0.0) (2021-12-31)

### Bug Fixes

- tree hooks 重构 ([6034a60](https://github.com/NSFI/ppfish-components/commit/6034a607761c1c2fddc6883c9e3078cb878614de))
- TreeSelect hooks 重构 ([f87e92b](https://github.com/NSFI/ppfish-components/commit/f87e92b4d146fba3281ce973b233264db827e1c1))

# [2.0.0-rc.1](https://github.com/NSFI/ppfish-components/compare/v2.0.0-beta.2...v2.0.0-rc.1) (2021-12-19)

### Bug Fixes

- 修复 Select 组件 控制台报错（Option 未转发 ref） ([ce1dc83](https://github.com/NSFI/ppfish-components/commit/ce1dc83230d45e6ac17a1e5f7ee35580ee09c071))

# [2.0.0-beta.2](https://github.com/NSFI/ppfish-components/compare/v2.0.0-beta.1...v2.0.0-beta.2) (2021-12-09)

# [2.0.0-beta.1](https://github.com/NSFI/ppfish-components/compare/v2.0.0-alpha.3...v2.0.0-beta.1) (2021-12-03)

### Bug Fixes

- Modal 添加测试、修复 eslint 错误 ([5949515](https://github.com/NSFI/ppfish-components/commit/59495155ed56bb42ee144da9cc9a7ec2fed8ad4f))

# [2.0.0-alpha.3](https://github.com/NSFI/ppfish-components/compare/v2.0.0-alpha.2...v2.0.0-alpha.3) (2021-11-12)

### Bug Fixes

- eslint warnings ([486d8b5](https://github.com/NSFI/ppfish-components/commit/486d8b5bc5a79de20157bb2cbda01be1cbf29127))

# [2.0.0-alpha.2](https://github.com/NSFI/ppfish-components/compare/v2.0.0-alpha.1...v2.0.0-alpha.2) (2021-10-15)
...
- 修复 less 文件中编程函数不生效的文件 ([ffbec4c](https://github.com/NSFI/ppfish-components/commit/ffbec4c575a7b0a28978739baa1ed3142f2d5c03))
...
- 防止快速切换时，innerSpinning 未能展示正确的状态 ([945bd2e](https://github.com/NSFI/ppfish-components/commit/945bd2e26cf2ae6d2e2105c356ec1863e34e80b9))

### Features

- 为部分组件的显隐增加动画效果 ([6d00def](https://github.com/NSFI/ppfish-components/commit/6d00def76478ff34e269b537c27b42fef74c3838))

# [2.0.0-alpha.1](https://github.com/NSFI/ppfish-components/compare/v1.8.2-rc.2...v2.0.0-alpha.1) (2021-09-10)

### Bug Fixes

- 修复 button 文档错误和 checkbox 中 defaultChecked 属性不生效的问题 ([229313f](https://github.com/NSFI/ppfish-components/commit/229313f356bc5c50e4ca6720f534931ba83913fc))
- 修复搜索后再次展开下拉框时，无法高亮选中项 ([3b12f3e](https://github.com/NSFI/ppfish-components/commit/3b12f3e05df472f6fb61ec8928e66029c36c09a4))
- 修复部分文件的 ts 错误和测试用例错误 ([7573685](https://github.com/NSFI/ppfish-components/commit/75736859bfc21ece3207279596890e587f0e187f))
...
- npm 编译打出的 es 包，有部分文件没有编译为 es5 语法,修改打包脚本处理 ([04f7e73](https://github.com/NSFI/ppfish-components/commit/04f7e73e760c6e2df68e5f31e4c16596b82db95b))
