    ...
    value: function render() {
      ...
      var handles = bounds.map(function (v, i) {
        ...
        return handleGenerator({
          className: (0, _classnames["default"])((_classNames = {}, _defineProperty(_classNames, handleClassName, true), _defineProperty(_classNames, "".concat(handleClassName, "-").concat(i + 1), true), _classNames)),
          prefixCls: prefixCls,
          vertical: vertical,
          offset: offsets[i],
          value: v,
      ...
      var tracks = bounds.slice(0, -1).map(function (_, index) {
        ...
        var i = index + 1;
        var trackClassName = (0, _classnames["default"])((_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-track"), true), _defineProperty(_classNames2, "".concat(prefixCls, "-track-").concat(i), true), _classNames2));
