...
function (_React$Component) {
  ...
  _createClass(Handle, [{
    ...
    value: function render() {
      ...
      var elClassName = (0, _classnames["default"])((_classNames = {}, _defineProperty(_classNames, this.props.className, true), _defineProperty(_classNames, "".concat(prefixCls, "-handle-custom"), !!this.props.handle), _defineProperty(_classNames, "".concat(prefixCls, "-handle-click-focused"), this.state.clickFocused), _classNames));
