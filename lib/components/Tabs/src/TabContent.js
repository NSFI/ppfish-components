...
function (_React$Component) {
  ...
  _createClass(TabContent, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames2["default"])((_classnames = {}, _defineProperty(_classnames, "".concat(prefixCls, "-content"), true), _defineProperty(_classnames, animated ? "".concat(prefixCls, "-content-animated") : "".concat(prefixCls, "-content-no-animated"), true), _classnames));
