...
function (_React$Component) {
  ...
  _createClass(Select, [{
    ...
    value: function getDropdownPanel() {
      ...
      var dropdownPanelCls = (0, _classnames["default"])(dropdownCls, _defineProperty({}, dropdownClassName, !!dropdownClassName));
      ...
      !searchValue && showSelectAll && mode === 'multiple' && _react["default"].createElement("li", {
        className: (0, _classnames["default"])(_defineProperty({}, "".concat(dropdownCls, "-option-item"), true), _defineProperty({}, 'checked checked-icon', this.isSelectAll())),
    ...
    value: function getSelectionPanel() {
      ...
      var selectionPanelCls = (0, _classnames["default"])(_defineProperty({}, "".concat(selectionCls), true), _defineProperty({}, className, !!className), _defineProperty({}, "".concat(selectionCls, "-disabled"), disabled), _defineProperty({}, "open", popupVisible), _defineProperty({}, "".concat(selectionCls, "-large"), size === 'large'), _defineProperty({}, "".concat(selectionCls, "-small"), size === 'small'));
      ...
      showArrow && !labelClear && _react["default"].createElement("div", {
        ...
        type: "down-fill",
        className: (0, _classnames["default"])(_defineProperty({}, 'open', popupVisible))
