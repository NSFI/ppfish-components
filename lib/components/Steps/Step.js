...
function (_React$Component) {
  ...
  _createClass(Step, [{
    ...
    value: function renderIconNode() {
      ...
      var iconNode;
      var iconClassName = (0, _classnames["default"])("".concat(prefixCls, "-icon"), "".concat(iconPrefix, "icon"), (_classNames = {}, _defineProperty(_classNames, "".concat(iconPrefix, "icon-").concat(icon), icon && isString(icon)), _defineProperty(_classNames, "".concat(iconPrefix, "icon-check-line"), !icon && status === 'finish'), _defineProperty(_classNames, "".concat(iconPrefix, "icon-close-tag-line"), !icon && status === 'error'), _classNames));
    ...
    value: function render() {
      ...
      var classString = (0, _classnames["default"])("".concat(prefixCls, "-item"), "".concat(prefixCls, "-item-").concat(status), className, _defineProperty({}, "".concat(prefixCls, "-item-custom"), icon));
