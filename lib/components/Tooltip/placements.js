...
function getPlacements(config) {
  ...
  var _a = config.arrowWidth,
      arrowWidth = _a === void 0 ? 5 : _a,
      _b = config.horizontalArrowShift,
      horizontalArrowShift = _b === void 0 ? 16 : _b,
      _c = config.verticalArrowShift,
      verticalArrowShift = _c === void 0 ? 12 : _c,
      _d = config.autoAdjustOverflow,
      autoAdjustOverflow = _d === void 0 ? true : _d;
  var placementMap = {
    left: {
      points: ['cr', 'cl'],
      offset: [-4, 0]
