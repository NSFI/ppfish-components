  ...
  _createClass(Scrollbar, [{
    ...
    value: function render() {
      ...
      var view = _react["default"].createElement(viewComponent, {
        className: (0, _classnames["default"])("".concat(prefixCls, "-scrollbar__view"), viewClass),
        style: viewStyle,
        ref: 'resize'
      }, children);
      ...
      if (!_native) {
        var wrap = _react["default"].createElement("div", _extends({}, others, {
          ...
          className: (0, _classnames["default"])(wrapClass, "".concat(prefixCls, "-scrollbar__wrap"), gutter ? '' : "".concat(prefixCls, "-scrollbar__wrap--hidden-default"))
        }), view);
        ...
        nodes = [_react["default"].createElement("div", _extends({}, others, {
          key: 0,
          ref: "wrap",
          className: (0, _classnames["default"])(wrapClass, "".concat(prefixCls, "-scrollbar__wrap")),
          style: style
        }), view)];
      }

      return _react["default"].createElement('div', {
        className: (0, _classnames["default"])("".concat(prefixCls, "-scrollbar"), className)
      }, nodes);
    }
  }, {
    key: "wrap",
