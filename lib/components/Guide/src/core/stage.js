...
function (_Element) {
  ...
  _createClass(Stage, [{
    ...
    value: function attachNode() {
      ...
      this.node = stage;
      this.currentIndexNode = stage.querySelector(".".concat(_constants.CLASS_STAGE_INDEX));
    ...
    value: function show(position) {
      ...
      switch (this.options.counterPosition) {
        case 'leftBottom':
          this.currentIndexNode.className = "".concat(_constants.CLASS_STAGE_INDEX, " left-bottom");
          break;

        case 'rightTop':
          this.currentIndexNode.className = "".concat(_constants.CLASS_STAGE_INDEX, " right-top");
          break;

        case 'rightBottom':
          this.currentIndexNode.className = "".concat(_constants.CLASS_STAGE_INDEX, " right-bottom");
          break;

        case 'leftTop':
        default:
          this.currentIndexNode.className = "".concat(_constants.CLASS_STAGE_INDEX);
          break;
