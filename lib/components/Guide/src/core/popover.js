...
function (_Element) {
  ...
  _createClass(Popover, [{
    ...
    value: function attachNode() {
      ...
      this.node = popover;
      this.tipNode = popover.querySelector(".".concat(_constants.CLASS_POPOVER_TIP));
      this.titleNode = popover.querySelector(".".concat(_constants.CLASS_POPOVER_TITLE));
      this.descriptionNode = popover.querySelector(".".concat(_constants.CLASS_POPOVER_DESCRIPTION));
      this.footerNode = popover.querySelector(".".concat(_constants.CLASS_POPOVER_FOOTER));
      this.nextBtnNode = popover.querySelector(".".concat(_constants.CLASS_NEXT_STEP_BTN));
      this.prevBtnNode = popover.querySelector(".".concat(_constants.CLASS_PREV_STEP_BTN));
      this.closeBtnNode = popover.querySelector(".".concat(_constants.CLASS_CLOSE_BTN));
      this.skipBtnNode = popover.querySelector(".".concat(_constants.CLASS_SKIP_BTN));
    }
    /**
    ...
    value: function setInitialState() {
      ...
      this.node.querySelector(".".concat(_constants.CLASS_POPOVER_TIP)).className = _constants.CLASS_POPOVER_TIP;
    }
    /**
