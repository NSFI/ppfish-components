...
function (_React$Component) {
  ...
  Select.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (treeDataSimpleMode && (treeDataChanged || treeDataModeChanged)) {
      var simpleMapper = Object.assign({
        id: 'id',
        pId: 'pId',
        rootPId: null
    ...
    if (valueRefresh) {
      ...
      if (!latestValueList) {
        ...
        latestValueList = [].concat(prevState.valueList, prevState.missValueList);
      } // Get key by value
  ...
  function Select(_props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onValueTrigger", function (isAdd, nodeList, nodeEventInfo, nodeExtraInfo) {
      ...
      var extraInfo = Object.assign({}, nodeExtraInfo, {
        triggerValue: value,
        triggerNode: node
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "onTreeNodeCheck", function (_, nodeEventInfo) {
      ...
      if (treeCheckStrictly) {
        ...
        if (isAdd) {
          keyList = Array.from(new Set([].concat(oriKeyList, checkedNodeList.map(function (_ref12) {
    ...
    _defineProperty(_assertThisInitialized(_this), "setOpenState", function (open, byTrigger) {
      if (byTrigger === void 0) {
        byTrigger = false;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "triggerChange", function (missValueList, valueList, extraInfo, immediate, triggerSelect) {
      if (extraInfo === void 0) {
        extraInfo = {};
      }
  ...
  _proto.render = function render() {
    ...
    var rtValueList = Array.isArray(curValueList) ? [].concat(curValueList) : [curValueList]; // 非 treeCheckStrictly 下的多选，在选中节点后有父子层级的联动
    ...
    var passProps = Object.assign({}, this.props, {
...
_defineProperty(Select, "childContextTypes", {
  rcTreeSelect: _propTypes.default.shape(Object.assign({}, _BaseSelector.selectorContextTypes, {}, _MultipleSelector.multipleSelectorContextTypes, {}, _BasePopup.popupContextTypes, {
