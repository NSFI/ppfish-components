...
xdescribe('Upload List', () => {
  ...
  it('should use file.thumbUrl for <img /> in priority', () => {
    ...
    fileList.forEach((file, i) => {
      ...
      const imgNode = wrapper.find('.fishd-upload-list-item-thumbnail img').at(i);
  ...
  it('should support onPreview', () => {
    ...
    wrapper.find('.fishdicon-eye-o').at(1).simulate('click');
  ...
  it('should support onRemove', async () => {
    ...
    wrapper.find('.fishdicon-delete').at(1).simulate('click');
