...
const isInputValid = (text, date, disabledDate) => {
  if (text.trim() === '' || !isValidValueArr(date) || !DateRangePanel.isValid(date, disabledDate))
    return false;
  return true;
};
  ...
  render() {
    ...
    return (
      <ConfigConsumer componentName="DatePicker">
        {(Locales, lang) => (
          <div
            className={classNames(`${prefixCls}-picker-panel`, `${prefixCls}-date-range-picker`, {
                ...
                >
                  <div className={`${prefixCls}-date-range-picker__header`}>
                    ...
                    <YearAndMonthPopover
                      ...
                      onChange={month =>
                        this.handleChangeMonth.call(this, 'leftDate', leftDate, month, Locales)
                      }
                    >
                      <span className={`${prefixCls}-date-range-picker__header-label`}>
                ...
                >
                  <div className={`${prefixCls}-date-range-picker__header`}>
                    ...
                    <YearAndMonthPopover
                      ...
                      sourceData={Locales.MONTH_ARRAY}
                      onChange={month =>
                        this.handleChangeMonth.call(this, 'rightDate', rightDate, month, Locales)
                      }
                    >
                      <span className={`${prefixCls}-date-range-picker__header-label`}>
