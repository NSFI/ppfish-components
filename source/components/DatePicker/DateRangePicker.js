...
export default class DateRangePicker extends DateRangeBasePicker {
  ...
  static get defaultProps() {
    return Object.assign(
      ...
      DateRangeBasePicker.defaultProps,
    );
  }
    ...
    if (this.props.showTime) {
      ...
      const startTimeSelectValid =
        ...
        TimeSelectPanel.isValid(
          this.dateToStr(startTime).split(' ')[1],
          this.props.startTimeSelectModeProps,
        );
      ...
      const endTimeSelectValid =
        ...
        TimeSelectPanel.isValid(
          this.dateToStr(endTime).split(' ')[1],
          this.props.endTimeSelectModeProps,
        );
  ...
  onError = value => {
    return this.props.onError && typeof this.props.onError === 'function'
