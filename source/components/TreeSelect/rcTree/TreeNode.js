...
class TreeNode extends React.Component {
  ...
  renderSwitcher = () => {
      ...
      return (
        <span className={classNames(`${prefixCls}-switcher`, `${prefixCls}-switcher-noop`)}>
          {typeof switcherIcon === 'function'
            ? React.createElement(switcherIcon, { ...this.props, isLeaf: true })
            : switcherIcon}
        </span>
      );
    }
    ...
    return (
      <span onClick={this.onExpand} className={switcherCls}>
        {typeof switcherIcon === 'function'
          ? React.createElement(switcherIcon, { ...this.props, isLeaf: false })
          : switcherIcon}
      </span>
    );
  };
  ...
  renderIcon = () => {
    ...
    const {
      rcTree: { prefixCls, showIcon, icon: treeIcon, loadData },
    } = this.context;
    ...
    return (
      <span className={`${prefixCls}-iconCtner`}>
        {loadingIcon}
        {customIcon}
      </span>
    );
