...
export var getSiblings = function getSiblings(elem) {
  var siblings = [];
...
export var addEventListener = function addEventListener(target, eventType, callback) {
  function wrapCallback(e) {
    var ne = new EventObject(e);
  ...
  if (target.addEventListener) {
    ...
    target.attachEvent("on".concat(eventType), wrapCallback);
    return {
      remove: function remove() {
        target.detachEvent("on".concat(eventType), wrapCallback);
      }
    };
  }
};
