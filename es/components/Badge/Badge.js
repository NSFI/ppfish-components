...
function (_super) {
  ...
  Badge.prototype.render = function () {
    ...
    var statusCls = classNames((_a = {}, _a[prefixCls + "-status-dot"] = !!status, _a[prefixCls + "-status-" + status] = !!status, _a));
    var scrollNumberCls = classNames((_b = {}, _b[prefixCls + "-dot"] = isDot, _b[prefixCls + "-count"] = !isDot, _b[prefixCls + "-multiple-words"] = !isDot && count && count.toString && count.toString().length > 1, _b[prefixCls + "-status-" + status] = !!status, _b));
    var badgeCls = classNames(className, prefixCls, (_c = {}, _c[prefixCls + "-status"] = !!status, _c[prefixCls + "-not-a-wrapper"] = !children, _c));
