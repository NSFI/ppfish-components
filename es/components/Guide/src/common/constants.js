...
var ID_OVERLAY = prefix + "-driver-page-overlay";
exports.ID_OVERLAY = ID_OVERLAY;
var ID_STAGE = prefix + "-driver-highlighted-element-stage";
exports.ID_STAGE = ID_STAGE;
var ID_POPOVER = prefix + "-driver-popover-item";
exports.ID_POPOVER = ID_POPOVER;
var CLASS_DRIVER_HIGHLIGHTED_ELEMENT = prefix + "-driver-highlighted-element";
exports.CLASS_DRIVER_HIGHLIGHTED_ELEMENT = CLASS_DRIVER_HIGHLIGHTED_ELEMENT;
var CLASS_POSITION_RELATIVE = prefix + "-driver-position-relative";
exports.CLASS_POSITION_RELATIVE = CLASS_POSITION_RELATIVE;
var CLASS_FIX_STACKING_CONTEXT = prefix + "-driver-fix-stacking";
exports.CLASS_FIX_STACKING_CONTEXT = CLASS_FIX_STACKING_CONTEXT;
var CLASS_STAGE_NO_ANIMATION = prefix + "-driver-stage-no-animation";
exports.CLASS_STAGE_NO_ANIMATION = CLASS_STAGE_NO_ANIMATION;
var CLASS_POPOVER_TIP = prefix + "-driver-popover-tip";
exports.CLASS_POPOVER_TIP = CLASS_POPOVER_TIP;
var CLASS_POPOVER_TITLE = prefix + "-driver-popover-title";
exports.CLASS_POPOVER_TITLE = CLASS_POPOVER_TITLE;
var CLASS_POPOVER_DESCRIPTION = prefix + "-driver-popover-description";
exports.CLASS_POPOVER_DESCRIPTION = CLASS_POPOVER_DESCRIPTION;
var CLASS_POPOVER_FOOTER = prefix + "-driver-popover-footer";
exports.CLASS_POPOVER_FOOTER = CLASS_POPOVER_FOOTER;
var CLASS_CLOSE_BTN = prefix + "-driver-close-btn";
exports.CLASS_CLOSE_BTN = CLASS_CLOSE_BTN;
var CLASS_SKIP_BTN = prefix + "-driver-skip-btn";
exports.CLASS_SKIP_BTN = CLASS_SKIP_BTN;
var CLASS_NEXT_STEP_BTN = prefix + "-driver-next-btn";
exports.CLASS_NEXT_STEP_BTN = CLASS_NEXT_STEP_BTN;
var CLASS_PREV_STEP_BTN = prefix + "-driver-prev-btn";
exports.CLASS_PREV_STEP_BTN = CLASS_PREV_STEP_BTN;
var CLASS_BTN_DISABLED = prefix + "-driver-disabled";
exports.CLASS_BTN_DISABLED = CLASS_BTN_DISABLED;
var CLASS_NAVIGATION_BTNS = prefix + "-driver-navigation-btns";
exports.CLASS_NAVIGATION_BTNS = CLASS_NAVIGATION_BTNS;
var CLASS_STAGE_INDEX = prefix + "-driver-stage-index"; // NOTE: It must match the one set in the animations in CSS file
...
var POPOVER_HTML = function POPOVER_HTML(className) {
  if (className === void 0) {
    className = '';
  }
...
var OVERLAY_HTML = "<div id=\"" + ID_OVERLAY + "\"></div>";
