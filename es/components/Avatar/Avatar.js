...
function (_super) {
  ...
  Avatar.prototype.render = function () {
    ...
    var _d = this.state,
        ...
        scale = _d.scale;
    var sizeCls = classNames((_a = {}, _a[prefixCls + "-lg"] = size === 'large', _a[prefixCls + "-sm"] = size === 'small', _a));
    var classString = classNames(prefixCls, className, sizeCls, (_b = {}, _b[prefixCls + "-" + shape] = shape, _b[prefixCls + "-image"] = src && isImgExist, _b[prefixCls + "-icon"] = icon, _b));
