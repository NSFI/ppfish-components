...
function (_React$Component) {
  ...
  _createClass(Option, [{
    ...
    value: function render() {
      ...
      var optionCls = classNames(_defineProperty({}, "".concat(prefixCls, "-item"), true), _defineProperty({}, "checked", !!checked), _defineProperty({}, "checked-icon", !!checked && showOptionCheckedIcon), _defineProperty({}, "active", 'activeKey' in this.props && activeKey === value), _defineProperty({}, "".concat(prefixCls, "-item-disabled"), !!disabled));
