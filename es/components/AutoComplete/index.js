...
function (_super) {
  ...
  AutoComplete.prototype.render = function () {
    ...
    var cls = classNames((_a = {}, _a[prefixCls + "-lg"] = size === 'large', _a[prefixCls + "-sm"] = size === 'small', _a[className] = !!className, _a[prefixCls + "-show-search"] = true, _a[prefixCls + "-auto-complete"] = true, _a));
    var options;
