...
function (_vjsComponent) {
  _inherits(vjsFullScreen, _vjsComponent);

  function vjsFullScreen(player, options) {
    var _this;

    _classCallCheck(this, vjsFullScreen);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(vjsFullScreen).call(this, player, options));
