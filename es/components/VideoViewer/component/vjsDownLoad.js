...
function (_vjsComponent) {
  _inherits(vjsDownLoad, _vjsComponent);

  function vjsDownLoad(player, options) {
    var _this;

    _classCallCheck(this, vjsDownLoad);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(vjsDownLoad).call(this, player, options));
