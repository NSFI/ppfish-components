...
function (_React$PureComponent) {
  _inheritsLoose(Drawer, _React$PureComponent);

  Drawer.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
  ...
  function Drawer(_props) {
        ...
        if (getContainer === 'body') {
          ...
          if (open && document.body.style.overflow !== 'hidden') {
            ...
            if (right) {
              ...
              switch (placement) {
                case 'right':
                  ...
                  _this.dom.style.msTransform = "translateX(-" + right + "px)";
                  break;
              ...
              _this.timeout = setTimeout(function () {
                _this.dom.style.transition = trannsformTransition + "," + widthTransition;
            ...
            if ((_this.isOpenChange || openTransition) && right) {
              ...
              clearTimeout(_this.timeout);
              _this.timeout = setTimeout(function () {
                _this.dom.style.transition = trannsformTransition + "," + (heightTransition ? heightTransition + "," : '') + widthTransition;
                _this.dom.style.transform = '';
                _this.dom.style.msTransform = '';
                _this.dom.style.width = '';
    ...
    _defineProperty(_assertThisInitialized(_this), "getChildToRender", function (open) {
      ...
      var wrapperClassname = (0, _classnames2.default)(prefixCls, (_classnames = {}, _classnames[prefixCls + "-" + placement] = true, _classnames[prefixCls + "-open"] = open, _classnames[className] = !!className, _classnames));
      ...
      return _react.default.createElement("div", {
        ...
        style: {
          ...
          width: (0, _utils2.isNumeric)(width) ? width + "px" : width,
          height: (0, _utils2.isNumeric)(height) ? height + "px" : height
        },
        ref: function ref(c) {
