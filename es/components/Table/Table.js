...
function getComponents(state, components, prevComponents) {
  ...
  newState.components = __assign(__assign({}, components), {
    body: __assign(__assign({}, components.body), {
...
function (_super) {
  ...
  function Table(props) {
    ...
    _this.onRow = function (record, index) {
      ...
      return __assign(__assign({}, custom), {
        prefixCls: prefixCls,
        store: _this.store,
    ...
    _this.handleFilter = function (column, nextFilters) {
      ...
      var filters = __assign(__assign({}, _this.state.filters), (_a = {}, _a[_this.getColumnKey(column)] = nextFilters, _a)); // Remove filters not in current columns
      ...
      var filtersToSetState = __assign({}, filters); // Remove filters which is controlled
      ...
      _this.setState(newState, function () {
        ...
        if (onChange) {
          onChange.apply(null, _this.prepareParamsArguments(__assign(__assign({}, _this.state), {
            selectionDirty: false,
            filters: filters,
            pagination: pagination
          })));
    ...
    _this.handleShowSizeChange = function (current, pageSize) {
      ...
      var nextPagination = __assign(__assign({}, pagination), {
        pageSize: pageSize,
        current: current
      });
    ...
    _this.renderTable = function (loading) {
      var _a;
      ...
      var _b = _this.props,
          ...
          showHeader = _b.showHeader,
          activeRowByClick = _b.activeRowByClick,
          restProps = __rest(_b, ["style", "className", "prefixCls", "showHeader", "activeRowByClick"]);
  ...
  Table.getDerivedStateFromProps = function (nextProps, prevState) {
    ...
    if (getSortOrderColumns(columns).length > 0) {
      ...
      if (sortState.sortColumn !== prevState.sortColumn || sortState.sortOrder !== prevState.sortOrder) {
  ...
  Table.prototype.getDefaultPagination = function (props) {
    ...
    return this.hasPagination(props) ? __assign(__assign(__assign({}, defaultPagination), pagination), {
  ...
  Table.prototype.toggleSortOrder = function (order, column) {
    var _a = this.state,
        sortColumn = _a.sortColumn,
        sortOrder = _a.sortOrder; // 只同时允许一列进行排序，否则会导致排序顺序的逻辑问题
  ...
  Table.prototype.renderRowSelection = function (locale) {
    ...
    if (rowSelection) {
      ...
      var _c = rowSelection.showSelectAll,
          showSelectAll = _c === void 0 ? true : _c;
  ...
  Table.prototype.renderColumnsFiltrate = function (columnsProps) {
    var _a = this.props,
        prefixCls = _a.prefixCls,
        columnFiltrate = _a.columnFiltrate;
    ...
    return (0, _util.treeMap)(columns, function (originColumn, i) {
      ...
      if (column.sorter) {
        ...
        if (column.sorterType === 'firstLetter') {
          var sortButtonInner = function sortButtonInner() {
            if (isAscend_1) {
              return React.createElement("span", {
                className: prefixCls + "-column-sorter-up " + (isAscend_1 ? 'on' : 'off'),
              ...
              return React.createElement("span", {
                ...
                onClick: function onClick() {
                  return _this.toggleTwoStateSortOrder('descend', column);
                },
                style: {
                  top: -2
                }
  ...
  Table.prototype.prepareParamsArguments = function (state) {
    var pagination = __assign({}, state.pagination); // remove useless handle function in Table.onChange
  ...
  Table.prototype.recursiveSort = function (data, sorterFn) {
    ...
    var _a = this.props.childrenColumnName,
        childrenColumnName = _a === void 0 ? 'children' : _a;
    return data.sort(sorterFn).map(function (item) {
      var _a;

      return item[childrenColumnName] ? __assign(__assign({}, item), (_a = {}, _a[childrenColumnName] = _this.recursiveSort(item[childrenColumnName], sorterFn), _a)) : item;
    });
  };
  ...
  Table.prototype.render = function () {
    ...
    var table = React.createElement("div", null, this.renderTable(loading)); // if there is no pagination or no data,
