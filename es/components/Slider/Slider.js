...
function (_super) {
  ...
  function Slider(props) {
    ...
    _this.sliderHandle = function (_a) {
      ...
      if (tipMode === 'all') {
        return React.createElement(RcHandle, __assign({}, restProps, {
          handle: handle,
          value: value
        }));
      }
      ...
      return React.createElement(Tooltip, {
        ...
        key: index,
        stretch: "minWidth"
      }, React.createElement(RcHandle, __assign({}, restProps, {
        value: value,
        handle: handle,
  ...
  Slider.prototype.render = function () {
    ...
    if (range) {
      return React.createElement(RcRange, __assign({}, restProps, {
        ref: this.saveSlider,
        handle: this.sliderHandle
      }));
    }

    return React.createElement(RcSlider, __assign({}, restProps, {
      ref: this.saveSlider,
      handle: this.sliderHandle
    }));
  };
