...
function (_super) {
  ...
  function Upload(props) {
    ...
    _this.renderUploadList = function (locale) {
      var _a = _this.props,
          ...
          showDeleteAll = _a.showDeleteAll;
      ...
      return React.createElement(UploadList, {
        ...
        onDeleteAll: _this.handleDeleteAll,
        showRemoveIcon: showRemoveIcon,
        showPreviewIcon: showPreviewIcon,
        maxFileCount: maxFileCount,
        showDeleteAll: showDeleteAll,
        locale: __assign(__assign({}, locale), _this.props.locale)
      });
    };
  ...
  Upload.prototype.render = function () {
    ...
    var _c = this.props,
        ...
        style = _c.style,
        showUploadList = _c.showUploadList,
    ...
    var rcUploadProps = __assign(__assign({
    ...
    var uploadList = showUploadList ? this.renderUploadList({
      uploading: '上传中',
      removeFile: '移除文件',
      uploadError: '上传错误',
      previewFile: '预览文件'
    }) : null;
    var uploadTips = tip ? React.createElement("div", {
    ...
    if (listType === 'picture-card') {
      return React.createElement("span", {
        className: className,
        style: style
      }, uploadList, uploadButton, uploadTips);
    } else {
      return React.createElement("span", {
        className: className,
        style: style
      }, uploadButton, uploadTips, uploadList);
    }
  };
