...
function (_React$Component) {
  _inheritsLoose(TimeSelectPanel, _React$Component);

  TimeSelectPanel.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
  ...
  function TimeSelectPanel(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "scrollToOption", function (className) {
      if (className === void 0) {
        className = "selected";
      }

      var menu = _this.timeSelectRoot.querySelector("." + _this.props.prefixCls + "-picker-panel__content");
  ...
  var _proto = TimeSelectPanel.prototype;
  ...
  _proto.handleClick = function handleClick(item) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement("div", {
      ...
      wrapClass: prefixCls + "-picker-panel__content",
      noresize: true
