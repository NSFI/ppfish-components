...
function (_React$Component) {
  _inheritsLoose(DateRangePanel, _React$Component);

  DateRangePanel.propsToState = function propsToState(props) {
  ...
  DateRangePanel.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    // 只 value 受控
  ...
  function DateRangePanel(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getMaxTime", function (maxTime, minTime) {
      ...
      if (endTimeSelectMode === 'TimePicker') {
        ...
        return maxTime && _TimeSelectPanel.default.isValid(maxTime.getHours() + ":" + maxTime.getMinutes(), _this.getEndTimeSelectableRange(minTime)) ? maxTime : null;
      }
    });
  ...
  var _proto = DateRangePanel.prototype;

  _proto.handleChangeRange = function handleChangeRange(rangeState) {
    this.setState({
  ...
  // 开始日期或结束日期发生改变
  _proto.handleDateInputChange = function handleDateInputChange(e, type) {
    var _this2 = this;
    ...
    if (!isInputValid(inputText, type === 'min' ? [ndate, maxDate] : [minDate, ndate], disabledDate)) {
      ...
      this.setState((_this$setState = {}, _this$setState[text] = inputText, _this$setState));
    } else {
      var _this$setState2;

      this.setState((_this$setState2 = {}, _this$setState2[text] = inputText, _this$setState2[value] = new Date(ndate), _this$setState2), function () {
  ...
  // 开始时间或结束时间发生改变
  _proto.handleTimeInputChange = function handleTimeInputChange(value, type) {
    var _this3 = this;
  ...
  _proto.prevYear = function prevYear(type, date, callback) {
    var _this$setState3;
    ...
    this.setState((_this$setState3 = {}, _this$setState3[type] = (0, _date.prevYear)(date), _this$setState3), callback);
  } // 下一年
  ;

  _proto.nextYear = function nextYear(type, date, callback) {
    var _this$setState4;
    ...
    this.setState((_this$setState4 = {}, _this$setState4[type] = (0, _date.nextYear)(date), _this$setState4), callback);
  } // 上个月
  ;

  _proto.prevMonth = function prevMonth(type, date, callback) {
    var _this$setState5;
    ...
    this.setState((_this$setState5 = {}, _this$setState5[type] = (0, _date.prevMonth)(date), _this$setState5), callback);
  } // 下个月
  ;

  _proto.nextMonth = function nextMonth(type, date, callback) {
    var _this$setState6;
    ...
    this.setState((_this$setState6 = {}, _this$setState6[type] = (0, _date.nextMonth)(date), _this$setState6), callback);
  } // 左边日历的next year btn特殊处理: 左边日历的下一年面板日期大于右边日历，右边日历的年份+1
  ;

  // 切换年份
  _proto.handleChangeYear = function handleChangeYear(type, date, year) {
    var _this$setState7,
        _this4 = this;

    this.setState((_this$setState7 = {}, _this$setState7[type] = new Date(new Date(date).setFullYear(year)), _this$setState7), function () {
  ...
  _proto.handleChangeMonth = function handleChangeMonth(type, date, month) {
    var _this$setState8,
        _this5 = this;

    this.setState((_this$setState8 = {}, _this$setState8[type] = new Date(new Date(date).setMonth(parseInt(month.slice(0, -1)) - 1)), _this$setState8), function () {
  ...
  _proto.handleRangePick = function handleRangePick(_ref, isClose) {
    var _this6 = this;
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement("div", {
      className: (0, _classnames.default)(prefixCls + "-picker-panel", prefixCls + "-date-range-picker", {
      ...
      className: prefixCls + "-picker-panel__sidebar"
      ...
      className: prefixCls + "-date-range-picker__time-header"
      ...
      className: prefixCls + "-date-range-picker__header"
    ...
    }, leftDate.getFullYear() + " " + t('datepicker.year'))), _react.default.createElement(_YearAndMonthPopover.default, {
      value: leftDate.getMonth() + 1,
      sourceData: _date.MONTH_ARRRY,
      onChange: this.handleChangeMonth.bind(this, 'leftDate', leftDate)
    }, _react.default.createElement("span", {
      className: prefixCls + "-date-range-picker__header-label"
    }, t("datepicker.month" + (leftDate.getMonth() + 1)))), _react.default.createElement(_index2.default, {
      type: "right-double",
      ...
      className: prefixCls + "-date-range-picker__header-label"
    }, rightDate.getFullYear() + " " + t('datepicker.year'))), _react.default.createElement(_YearAndMonthPopover.default, {
      value: rightDate.getMonth() + 1,
      sourceData: _date.MONTH_ARRRY,
      onChange: this.handleChangeMonth.bind(this, 'rightDate', rightDate)
    }, _react.default.createElement("span", {
      className: prefixCls + "-date-range-picker__header-label"
    }, t("datepicker.month" + (rightDate.getMonth() + 1)))), _react.default.createElement(_index2.default, {
      type: "right-double",
      ...
      type: "primary",
      className: (0, _classnames.default)(prefixCls + "-picker-panel__btn confirm", {
...
_defineProperty(DateRangePanel, "getEndTimeSelectableRange", function (_ref2) {
  ...
  if (endTimeSelectMode === 'TimePicker') {
    ...
    if (propsTimeRangeArr && propsTimeRangeArr.length > 0) {
      ...
      for (var _iterator = propsTimeRangeArr, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref3;
