...
function (_BasePicker) {
  ...
  _createClass(TimeSelect, [{
    ...
    value: function isDateValid(value) {
      return _get(_getPrototypeOf(TimeSelect.prototype), "isDateValid", this).call(this, value) && TimeSelectPanel.isValid(this.dateToStr(value), this.props);
    }
  }, {
    key: "pickerPanel",
    value: function pickerPanel(state) {
      ...
      return React.createElement(TimeSelectPanel, _extends({}, this.props, {
        value: value,
