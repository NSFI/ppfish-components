...
function (_React$Component) {
  _inheritsLoose(DateTable, _React$Component);
  ...
  _proto.getOffsetWeek = function getOffsetWeek() {
  ...
  _proto.getCellClasses = function getCellClasses(cell) {
  ...
  _proto.getMarkedRangeRows = function getMarkedRangeRows() {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement("table", {
      ...
      className: (0, _classnames.default)(prefixCls + "-date-table", {
      ...
      return _react.default.createElement("tr", {
        key: idx,
        className: (0, _classnames.default)(prefixCls + "-date-table__row", {
